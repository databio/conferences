...
// "AI + contribute" section pointing at the update instructions / API / PR flow. Generated
...
export function landingHtml(repo: string): string {
  ...
  const instructionsUrl = `https://github.com/${repo}/blob/main/automation/update-conferences.md`
...
<body><main id="top">
  ...
  <section class="ai">
    ...
    <ul>
      ...
      <li><strong>How the agent maintains it:</strong> <a href="${instructionsUrl}" target="_blank" rel="noopener">update-conferences.md</a> — the instructions a weekly AI agent follows to research and update the list.</li>
    </ul>
  </section>
